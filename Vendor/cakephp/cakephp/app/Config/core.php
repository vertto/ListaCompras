 ...
 */
	Configure::write('Security.salt', 'RFRfjjhbjhohDYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '898854896898976859309657453542496749683645');
